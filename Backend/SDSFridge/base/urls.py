...
urlpatterns = [
    ...
    path('phone/<int:pk>/', views.UserPhoneDetailView.as_view(), name='read_UserPhone'),
    path('create_UserPhone/', views.UserPhoneCreateView.as_view(), name='create_UserPhone'),
    path('update_UserPhone/<int:pk>/', views.UserPhoneUpdateView.as_view(), name='update_UserPhone'),
    path('delete_UserPhone/<int:pk>/', views.UserPhoneDeleteView.as_view(), name='delete_UserPhone'),
    path('getPhones/',views.get_phones, name = 'get_phones'),
